    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.crewMembersContainer}>
          <View style={[styles.avatar, { backgroundColor: COLORS.primaryOrange }]}><Text style={styles.avatarText}>J</Text></View>
          <View style={[styles.avatar, { backgroundColor: COLORS.mascotGreen, marginLeft: -15 }]}><Text style={styles.avatarText}>S</Text></View>
          <View style={[styles.avatar, { backgroundColor: COLORS.secondaryYellow, marginLeft: -15 }]}><Text style={styles.avatarText}>M</Text></View>
          <View style={[styles.avatar, { backgroundColor: '#3498db', marginLeft: -15 }]}><Text style={styles.avatarText}>L</Text></View>
          <View style={[styles.avatar, { backgroundColor: '#e74c3c', marginLeft: -15 }]}><Text style={styles.avatarText}>R</Text></View>
        </View>
      </View>
      ...
      <TouchableOpacity 
        style={styles.batonCard}
        activeOpacity={0.8}
        onPress={() => console.log("Baton details openen...")}
      >
      ...
      <View style={styles.activitySection}>
        ...
        <View style={styles.activityItem}>
          <View style={[styles.smallAvatar, { backgroundColor: '#9b59b6' }]}><Text style={styles.smallAvatarText}>M</Text></View>
          <View style={styles.activityDetails}>
            <Text style={styles.activityUser}>Mark <Text style={styles.activityAction}>completed a run</Text></Text>
        ...
        {/* Activity Item 2 */}
        <View style={styles.activityItem}>
          <View style={[styles.smallAvatar, { backgroundColor: COLORS.primaryOrange }]}><Text style={styles.smallAvatarText}>J</Text></View>
          <View style={styles.activityDetails}>
            <Text style={styles.activityUser}>You <Text style={styles.activityAction}>completed a run</Text></Text>
        ...
        <View style={styles.activityItem}>
          <View style={[styles.smallAvatar, { backgroundColor: '#262a3e', borderWidth: 1, borderColor: COLORS.secondaryYellow }]}><Text style={styles.smallAvatarText}>🏃</Text></View>
          <View style={styles.activityDetails}>
            <Text style={styles.activityUser}>Baton Passed <Text style={styles.activityAction}>to Sarah</Text></Text>
